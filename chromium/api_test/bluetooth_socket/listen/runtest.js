...
const uuid = '2de497f9-ab28-49db-b6d2-066ea69f1737'
const clientAddress = '11:12:13:14:15:16'

function testListen () {
  chrome.test.assertEq(2, sockets.length)
  let serverSocket = sockets[0]; let clientSocket = sockets[1]
...
chrome.bluetoothSocket.create(
  ...
  function (socket) {
    ...
    chrome.bluetoothSocket.onAccept.addListener(
      function (info) {
        if (info.socketId != socket.socketId) { return }
